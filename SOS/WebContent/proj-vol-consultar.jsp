...
<html lang="pt-br">
  <head>
    ...
    <title>SOS | Consultar Voluntários Pendentes</title>
  ...
  <body class="overflow-hidden">
		...
		<div id="main-container">
			<div id="breadcrumb">
				<ul class="breadcrumb">
					 ...
					 <li class="active">Consultar voluntários pendentes</li>	 
				</ul>
			</div><!-- breadcrumb -->
            <div class="padding-md">
                ...
                <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                        	...
                        	<input name="acao" value="vCompativel" type="hidden">
	                            <div class="row">
                        ...
                        <c:if test="${empty voluntarios && not empty idProjeto}">
		                                    ...
		                                    <td>
		                                        <div class="btn-group">
		                                            ...
		                                            <ul class="dropdown-menu slidedown dropdown-menu-right">
		                                                ...
		                                                <li><a href="proj.do?acao=associar&idVoluntario=${v.id }&idProjeto=${idProjeto}"><i class="fa fa-group"></i> Associar</a></li>
		                                            </ul>
								                </div><!-- /btn-group -->
		                                    </td>
		                                </tr>
	...
	<div class="custom-popup width-100" id="logoutConfirm">
		...
		<div class="text-center">
			<a class="btn btn-success m-right-sm" href="login.jsp">Logout</a>
